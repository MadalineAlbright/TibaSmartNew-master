...
public class Adult_Chock extends AppCompatActivity implements TextToSpeech.OnInitListener  {
    ImageView imageView;
    TextToSpeech engine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adult__chock);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = YouTubeStandalonePlayer.createVideoIntent( Adult_Chock.this, YoutubeApiKey_Holder.getApiKey(),"PA9hpOnvtCk",100,true,true);
    ...
    private void speak() {
        ...
        String about_description=getResources().getString(R.string.adultchock_about_content);

        String title_mild=getResources().getString(R.string.title_mild);
        String mild_content=getResources().getString(R.string.mild_content);

        String title_severe=getResources().getString(R.string.title_severe);
        String severe_content=getResources().getString(R.string.severe_content);
