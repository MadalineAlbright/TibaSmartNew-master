...
public class Hypothermia extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ImageView imageView;
    TextToSpeech engine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = YouTubeStandalonePlayer.createVideoIntent( Hypothermia.this, YoutubeApiKey_Holder.getApiKey(),"qlNKCSC2s5w",100,true,true);
    ...
    private void speak() {
        ...
        String about_description=getResources().getString(R.string.hypothermia_recognition_content);

        String adultcpr_compression=getResources().getString(R.string.title_treatment);
        String adultcpr_compression_content=getResources().getString(R.string.hypothermia_treatment_content);
