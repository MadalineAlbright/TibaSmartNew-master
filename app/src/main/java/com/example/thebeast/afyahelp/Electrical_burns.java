...
public class Electrical_burns extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electrical_burns);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = YouTubeStandalonePlayer.createVideoIntent( Electrical_burns.this, YoutubeApiKey_Holder.getApiKey(),"FpC4fKPSuX4",100,true,true);
    ...
    private void speak() {
        ...
        String about_description=getResources().getString(R.string.electrical_priority_content);

        String adultcpr_compression=getResources().getString(R.string.title_treatment);
        String adultcpr_compression_content=getResources().getString(R.string.electrical_treatment_content);
