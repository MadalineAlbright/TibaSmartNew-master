...
public class Spider_bite extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ImageView imageView;
    TextToSpeech engine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spider_bite);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = YouTubeStandalonePlayer.createVideoIntent( Spider_bite.this, YoutubeApiKey_Holder.getApiKey(),"BQNNOh8c8ks",100,true,true);
    ...
    private void speak() {
        ...
        String about_description=getResources().getString(R.string.spider_recognition_content);

        String adultcpr_compression=getResources().getString(R.string.bites_priority);
        String adultcpr_compression_content=getResources().getString(R.string.spider_priority_content);

        String adultcpr_airway=getResources().getString(R.string.title_treatment);
        String adultcpr_airway_content=getResources().getString(R.string.spider_treatment_content);
