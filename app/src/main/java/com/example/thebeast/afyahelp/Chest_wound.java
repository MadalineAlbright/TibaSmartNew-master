...
public class Chest_wound extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ImageView imageView;
    TextToSpeech engine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chest_wound);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = YouTubeStandalonePlayer.createVideoIntent( Chest_wound.this, YoutubeApiKey_Holder.getApiKey(),"SWqZeqrWslQ",100,true,true);
    ...
    private void speak() {
        ...
        String about_description=getResources().getString(R.string.chest_wound_content);

        String title_mild=getResources().getString(R.string.title_treatment);
        String mild_content=getResources().getString(R.string.treatment_chest_content);
