...
public class Food_poisoning extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ImageView imageView;
    TextToSpeech engine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = YouTubeStandalonePlayer.createVideoIntent( Food_poisoning.this, YoutubeApiKey_Holder.getApiKey(),"K36B1wnMHIo",100,true,true);
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent in=new Intent(getApplicationContext(),Poison_main.class);
                startActivity(in);
    ...
    private void speak() {
        ...
        String about_description=getResources().getString(R.string.food_about_content);

        String adultcpr_compression=getResources().getString(R.string.title_recognition);
        String adultcpr_compression_content=getResources().getString(R.string.food_recognition_content);

        String adultcpr_airway=getResources().getString(R.string.food_explain_content);
        String adultcpr_airway_content=getResources().getString(R.string.food_content);

        String title_treatment=getResources().getString(R.string.title_treatment);
        String food_treatment_content=getResources().getString(R.string.food_treatment_content);

        String food_doctor=getResources().getString(R.string.food_doctor);
        String food_doctor_content=getResources().getString(R.string.food_doctor_content);



        engine.speak(about+".\n"+about_description+".\n"+adultcpr_compression+".\n"+adultcpr_compression_content
                        +".\n"+adultcpr_airway+".\n"+adultcpr_airway_content+".\n"+title_treatment+".\n"+food_treatment_content
                        +".\n"+food_doctor+".\n"+food_doctor_content,
