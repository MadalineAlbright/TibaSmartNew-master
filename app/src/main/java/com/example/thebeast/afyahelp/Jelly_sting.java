...
public class Jelly_sting extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ImageView imageView;
    TextToSpeech engine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jelly_sting);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = YouTubeStandalonePlayer.createVideoIntent( Jelly_sting.this, YoutubeApiKey_Holder.getApiKey(),"HHmQ59xOoY",100,true,true);
    ...
    private void speak() {
        ...
        String about_description=getResources().getString(R.string.jelly_recognition_content);

        String adultcpr_compression=getResources().getString(R.string.bites_priority);
        String adultcpr_compression_content=getResources().getString(R.string.jelly_priority_content);

        String adultcpr_airway=getResources().getString(R.string.title_treatment);
        String adultcpr_airway_content=getResources().getString(R.string.jelly_treatment_content);
