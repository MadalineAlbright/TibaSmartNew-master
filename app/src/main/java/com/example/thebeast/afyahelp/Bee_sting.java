...
public class Bee_sting extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bee_sting);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = YouTubeStandalonePlayer.createVideoIntent( Bee_sting.this, YoutubeApiKey_Holder.getApiKey(),"MbPDjtJ8n2g",100,true,true);
    ...
    private void speak() {
        ...
        String about=getResources().getString(R.string.title_recognition);
        String about_description=getResources().getString(R.string.bee_recognition_content);

        String adultcpr_compression=getResources().getString(R.string.bites_priority);
        String adultcpr_compression_content=getResources().getString(R.string.bee_recognition_content);

        String adultcpr_airway=getResources().getString(R.string.bites_priority);
        String adultcpr_airway_content=getResources().getString(R.string.bee_priority_content);

        String title_treatment=getResources().getString(R.string.title_treatment);
        String bee_treatment_content=getResources().getString(R.string.bee_treatment_content);


        engine.speak(about+".\n"+about_description+".\n"+adultcpr_compression+".\n"+adultcpr_compression_content
                        +"\n"+adultcpr_airway+".\n"+adultcpr_airway_content+".\n"+title_treatment+".\n"+bee_treatment_content,
