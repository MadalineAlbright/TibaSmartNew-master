...
public class Alcohol_poisoning extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ImageView imageView;
    TextToSpeech engine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alcohol_poisoning);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = YouTubeStandalonePlayer.createVideoIntent( Alcohol_poisoning.this, YoutubeApiKey_Holder.getApiKey(),"hduymDaVe84",100,true,true);
    ...
    private void speak() {
        ...
        String about_description=getResources().getString(R.string.alcohol_about_content);

        String adultcpr_compression=getResources().getString(R.string.title_recognition);
        String adultcpr_compression_content=getResources().getString(R.string.alcohol_recognition_content);

        String adultcpr_airway=getResources().getString(R.string.title_treatment);
        String adultcpr_airway_content=getResources().getString(R.string.alcohol_treatment_content);
