...
public class Ear_injury extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ImageView imageView;
    TextToSpeech engine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ear_injury);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = YouTubeStandalonePlayer.createVideoIntent( Ear_injury.this, YoutubeApiKey_Holder.getApiKey(),"R3jp7mPVCGY",100,true,true);
    ...
    private void speak() {
        ...
        String about_description=getResources().getString(R.string.ear_priority_content);
