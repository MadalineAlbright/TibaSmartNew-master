...
public class Burn_scalds extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_burn_scalds);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = YouTubeStandalonePlayer.createVideoIntent( Burn_scalds.this, YoutubeApiKey_Holder.getApiKey(),"EaJmzB8YgS0",100,true,true);
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent in=new Intent(getApplicationContext(),Heat_main.class);
                startActivity(in);
    ...
    private void speak() {
        ...
        String about_description=getResources().getString(R.string.burn_priority_content);

        String adultcpr_compression=getResources().getString(R.string.title_treatment);
        String adultcpr_compression_content=getResources().getString(R.string.burn_treatment_content);

        String adultcpr_airway=getResources().getString(R.string.burn_degree);
        String adultcpr_airway_content=getResources().getString(R.string.burn_degree_content);
