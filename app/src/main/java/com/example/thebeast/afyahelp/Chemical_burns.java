...
public class Chemical_burns extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ImageView imageView;
    TextToSpeech engine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chemical_burns);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = YouTubeStandalonePlayer.createVideoIntent( Chemical_burns.this, YoutubeApiKey_Holder.getApiKey(),"eNvXrSf3Cww",100,true,true);
    ...
    private void speak() {
        ...
        String about_description=getResources().getString(R.string.chemical_priority_content);

        String adultcpr_compression=getResources().getString(R.string.title_treatment);
        String adultcpr_compression_content=getResources().getString(R.string.chemical_treatment_content);
