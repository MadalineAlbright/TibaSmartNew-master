...
public class Swallowed_poison extends AppCompatActivity  implements TextToSpeech.OnInitListener{
    ImageView imageView;
    TextToSpeech engine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_swallowed_poison);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = YouTubeStandalonePlayer.createVideoIntent( Swallowed_poison.this, YoutubeApiKey_Holder.getApiKey(),"2Wg1bdxPGEM",100,true,true);
    ...
    private void speak() {
        ...
        String about_description=getResources().getString(R.string.swallowed_about_content);

        String adultcpr_compression=getResources().getString(R.string.title_recognition);
        String adultcpr_compression_content=getResources().getString(R.string.swallowed_recognition_content);

        String adultcpr_airway=getResources().getString(R.string.title_treatment);
        String adultcpr_airway_content=getResources().getString(R.string.swallowed_treatment_content);
