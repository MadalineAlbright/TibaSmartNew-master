...
public class Seizure extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ImageView imageView;
    TextToSpeech engine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = YouTubeStandalonePlayer.createVideoIntent( Seizure.this, YoutubeApiKey_Holder.getApiKey(),"Ovsw7tdneqE",100,true,true);
    ...
    private void speak() {
        ...
        String about_description=getResources().getString(R.string.seizure_about_content);

        String adultcpr_compression=getResources().getString(R.string.title_recognition);
        String adultcpr_compression_content=getResources().getString(R.string.seizure_recognition_content);

        String adultcpr_airway=getResources().getString(R.string.title_treatment);
        String adultcpr_airway_content=getResources().getString(R.string.seizure_treatment_content);
