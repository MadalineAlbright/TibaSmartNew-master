...
public class Adult_cpr extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ImageView imageView;
    TextToSpeech engine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adult_cpr);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = YouTubeStandalonePlayer.createVideoIntent( Adult_cpr.this, YoutubeApiKey_Holder.getApiKey(),"BQNNOh8c8ks",100,true,true);
    ...
    private void speak() {
        ...
        String about_description=getResources().getString(R.string.adultcpr_about_content);

        String adultcpr_compression=getResources().getString(R.string.adultcpr_compression);
        String adultcpr_compression_content=getResources().getString(R.string.adultcpr_compression_content);

        String adultcpr_airway=getResources().getString(R.string.adultcpr_airway);
        String adultcpr_airway_content=getResources().getString(R.string.adultcpr_airway_content);

        String adultcpr_breathing=getResources().getString(R.string.adultcpr_breathing);
        String adultcpr_breathing_content=getResources().getString(R.string.adultcpr_breathing_content);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.start_tts) {
            Toast.makeText(Adult_cpr.this,"Read the app contents",Toast.LENGTH_LONG).show();
            speak();
            return true;
        }
        else if (id == R.id.stop_tts) {
            Toast.makeText(Adult_cpr.this,"Stop reading the app contents",Toast.LENGTH_LONG).show();
            engine.stop();
            return true;
