...
public class Child_chock extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ImageView imageView;
    TextToSpeech engine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_child_chock);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = YouTubeStandalonePlayer.createVideoIntent( Child_chock.this, YoutubeApiKey_Holder.getApiKey(),"oswDpwzbAV8",100,true,true);
    ...
    private void speak() {
        ...
        String about=getResources().getString(R.string.title_infant_back);
        String about_description=getResources().getString(R.string.infant_back_content);

        String title_mild=getResources().getString(R.string.title_infant_chest);
        String mild_content=getResources().getString(R.string.infant_chest_content);
