...
public class Eye_injury extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ImageView imageView;
    TextToSpeech engine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eye_injury);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = YouTubeStandalonePlayer.createVideoIntent( Eye_injury.this, YoutubeApiKey_Holder.getApiKey(),"PHrrxe3p8vw",100,true,true);
    ...
    private void speak() {
        ...
        String about_description=getResources().getString(R.string.eye_priority_content);

        String adultcpr_compression=getResources().getString(R.string.title_treatment);
        String adultcpr_compression_content=getResources().getString(R.string.ear_treatment_content);
